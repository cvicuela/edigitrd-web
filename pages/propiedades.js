    ...
    <div className="min-h-screen bg-gray-100 px-6 py-10 text-slate-800">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded shadow-md overflow-hidden">
          <Image src="/local1.png" alt="Local en Salamanca, Madrid" width={600} height={400} />
          <div className="p-4">
        ...
        {/* Local 2 */}
        <div className="bg-white rounded shadow-md overflow-hidden">
          <Image src="/local2.png" alt="Local en Barrio Gótico, Barcelona" width={600} height={400} />
          <div className="p-4">
        ...
        {/* Apartamento */}
        <div className="bg-white rounded shadow-md overflow-hidden">
          <Image src="/local3.png" alt="Apartamento en Chamartín, Madrid" width={600} height={400} />
          <div className="p-4">
